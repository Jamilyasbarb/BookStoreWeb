...
import local.jamily.bookstoreweb.model.dao.UserDAO;
...
public class UserLoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Logger.getLogger(UserDAO.class.getName()).log(Level.INFO, "Email e Password {0} : {1}", new Object[] {auxEmail, auxPassword});
        ...
        try {
            ...
            //define destino padrão (página login)
            ...
            if (user != null) {
                ...
                Logger.getLogger(UserDAO.class.getName()).log(Level.INFO, "Usuário Logado: {0}", user.getEmail() + " | " + user.getFullName());
            } else {
                
                String msgAux = "Email ou Password inválido!!!";
                request.setAttribute("messageJamily", msgAux);
