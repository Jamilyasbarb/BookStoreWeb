...
import local.jamily.bookstoreweb.model.dao.BookDAO;
...
public class BookServelet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //listBook(request, response);
           ...
           Logger.getLogger(BookServelet.class.getName()).log(Level.INFO, "Path Solicitado: (0)", action);
    ...
    private void listBook(HttpServletRequest request, HttpServletResponse response)
        ...
        Logger.getLogger(BookDAO.class.getName()).log(Level.INFO, "Total de registros: {O}", listaBook.size());
        
        request.setAttribute("listaBook", listaBook);
        
        RequestDispatcher dispacher = request.getRequestDispatcher("/BookList.jsp");
